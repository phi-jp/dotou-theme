...
<div class="register-section" id="basic-details-section">
  ...
  <label for="signup_username">ユーザー名（必須）</label>
  <?php do_action( 'bp_signup_username_errors' ); ?>
  <input type="text" name="signup_username" id="signup_username" value="<?php bp_signup_username_value(); ?>" />

  <label for="signup_email">メールアドレス(必須)</label>
  ...
  <label for="signup_password_confirm">パスワード確認</label>
...
<div class="submit">
  ...
  <input class="btn" type="submit" name="signup_submit" id="signup_submit" value="Sign Up" />
</div>
...
<div class="sns_login">
  <h4>その他のサービスでログイン</h4>
  <?php
    do_action('gianism_regsiter_form');
  ?>
  <p class="caution">※登録時に自動で投稿などを行うことはありません。</p>
</div>
