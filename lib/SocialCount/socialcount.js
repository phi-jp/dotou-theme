	...
	var SocialCount = {
		...
		bindEvents: function( $el, url, facebookAction, isSmall ) {
			...
			if( !isSmall ) {
				...
				bind( $el.find( SocialCount.selectors.hatebu + ' a' ),
					'<a href="http://b.hatena.ne.jp/entry/" class="hatena-bookmark-button" data-hatena-bookmark-layout="standard" title="add hatena"><img src="http://b.st-hatena.com/images/entry-button/button-only.gif" alt="add hatena" width="20" height="20" style="border: none;" /></a>',
